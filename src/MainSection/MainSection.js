...
function MainSection() {
  return (
   ...
   <div id='secondsec'>
    <div class='corners'>
        <img src={wimg} style={{width:'350px', height:'350px', marginTop:'10px', marginLeft:'20px'}}></img>
    </div>
    <div class='corners'>
        <img src={mimg} style={{width:'350px', height:'350px', marginTop:'10px', marginLeft:'20px'}}></img>
    </div>
    <div class='corners'>
        <img src={gimg} style={{width:'350px', height:'350px', marginTop:'10px', marginLeft:'20px'}}></img>
    </div>
   </div>
   <div id='thirdSec'>
   <div id='textpara1'>
   <p>We are now open <b>24*7</b> in your area</p>
   </div >
   <div id='textpara2'>
