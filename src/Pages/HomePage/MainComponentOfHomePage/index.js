          ...
          <div>
            ...
            <div className="mainSection">
              ...
              <div className="thirdSec">
                ...
                <b>
                  <Text text={homeData.mainSection.timepara.para2} />
                </b>
                <Text text={homeData.mainSection.timepara.para3} />
              </div>
              <div className="fourthsec">
                <ProductImage
                  src={homeData.mainSection.offerImage}
                  style={{ width: "100%" }}
                />
              </div>
            </div>
            ...
            <div className="shopsection1">
              {homeData.shopSection.map((shopdata) => {
                return (
                  <div>
                    <Link to={`/shopsectionFirstroute/${shopdata.id}`}>
            ...
            <div className="shopsection2">
              {homeData.shopSection2.map((shopdata) => {
                return (
                  <div>
                    <Link to={`/shopsectionSecondroute/${shopdata.id}`}>
                      <ProductImage
                        src={shopdata.img}
                        style={{
                          height: "200px",
